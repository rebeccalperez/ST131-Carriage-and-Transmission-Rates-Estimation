...
parameters {
 ...
 transformed parameters{
 	...
 	matrix[K,K]	delta_theta_norm1[N1];	//normalised delta_theta1 (so row sums to 1) 
 	...
 	for(i in 1:N1){
 			theta_m1[i,1,2]=exp(X1[i,1]*beta12[1]+X1[i,2]*beta12[2]+X1[i,3]*beta12[3]);
  			theta_m1[i,1,1]=-theta_m1[i,1,2];
  			theta_m1[i,2,1]=exp(X1[i,1]*beta21[1]+X1[i,2]*beta21[1]+X1[i,3]*beta21[3]);
 	...
 	for(i in 1:N2){
 			theta_m2[i,1,2]=exp(X2[i,1]*beta12[1]+X2[i,2]*beta12[2]+X2[i,3]*beta12[3]);
  			theta_m2[i,1,1]=-theta_m2[i,1,2];
  			theta_m2[i,2,1]=exp(X2[i,1]*beta21[1]+X2[i,2]*beta21[2]+X2[i,3]*beta21[3]);
...
for(i in 1:N3){
 			theta_m3[i,1,2]=exp(X3[i,1]*beta12[1]+X3[i,2]*beta12[2]+X3[i,3]*beta12[3]);
  			theta_m3[i,1,1]=-theta_m3[i,1,2];
  			theta_m3[i,2,1]=exp(X3[i,1]*beta21[1]+X3[i,2]*beta21[2]+X3[i,3]*beta21[3]);
...
for(i in 1:N4){
 			theta_m4[i,1,2]=exp(X4[i,1]*beta12[1]+X4[i,2]*beta12[2]+X4[i,3]*beta12[3]);
  			theta_m4[i,1,1]=-theta_m4[i,1,2];
  			theta_m4[i,2,1]=exp(X4[i,1]*beta21[1]+X4[i,2]*beta21[2]+X4[i,3]*beta21[3]);
...
for(i in 1:N5){
 			theta_m5[i,1,2]=exp(X5[i,1]*beta12[1]+X5[i,2]*beta12[2]+X5[i,3]*beta12[3]);
  			theta_m5[i,1,1]=-theta_m5[i,1,2];
  			theta_m5[i,2,1]=exp(X5[i,1]*beta21[1]+X5[i,2]*beta12[2]+X5[i,3]*beta12[3]);
...
for(i in 1:N6){
 			theta_m6[i,1,2]=exp(X6[i,1]*beta12[1]+X6[i,2]*beta12[2]+X6[i,3]*beta12[3]);
  			theta_m6[i,1,1]=-theta_m6[i,1,2];
  			theta_m6[i,2,1]=exp(X6[i,1]*beta21[1]+X6[i,2]*beta21[2]+X6[i,3]*beta21[3]);
	...
	for(i in 1:N7){
 			theta_m7[i,1,2]=exp(X7[i,1]*beta12[1]+X7[i,2]*beta12[2]+X7[i,3]*beta12[3]);
  			theta_m7[i,1,1]=-theta_m7[i,1,2];
  			theta_m7[i,2,1]=exp(X7[i,1]*beta21[1]+X7[i,2]*beta21[2]+X7[i,3]*beta21[3]);
  			theta_m7[i,2,2]=-theta_m7[i,2,1];
  			
  			delta_theta7[i]=matrix_exp(delta_T7[i]*theta_m7[i,,]); //Compute the TP1 & TP2 interval probabilities
  		}	
 	
 	for(i in 1:N7)
 		for(j in 1:K)
 			for(l in 1:K)
 			delta_theta_norm7[i,j,l]=delta_theta7[i,j,l]/sum(delta_theta7[i,j,]); //normalising step so that row sum for each indiv. prob matrix is 1.
    
    for(i in 1:N8){
 			theta_m8[i,1,2]=exp(X8[i,1]*beta12[1]+X8[i,2]*beta12[2]);
  			theta_m8[i,1,1]=-theta_m8[i,1,2];
  			theta_m8[i,2,1]=exp(X8[i,1]*beta21[1]+X8[i,2]*beta21[2]);
  			theta_m8[i,2,2]=-theta_m8[i,2,1];
  			
  			delta_theta8[i]=matrix_exp(delta_T8[i]*theta_m8[i,,]); //Compute the TP1 & TP2 interval probabilities
  		}	
 	
 	for(i in 1:N8)
 		for(j in 1:K)
 			for(l in 1:K)
 			delta_theta_norm8[i,j,l]=delta_theta8[i,j,l]/sum(delta_theta8[i,j,]); //normalising step so that row sum for each indiv. prob matrix is 1.

    for(i in 1:N9){
 			theta_m9[i,1,2]=exp(X9[i,1]*beta12[1]+X9[i,2]*beta12[2]+X9[i,3]*beta12[3]);
  			theta_m9[i,1,1]=-theta_m9[i,1,2];
  			theta_m9[i,2,1]=exp(X9[i,1]*beta21[1]+X9[i,2]*beta21[2]+X9[i,3]*beta21[3]);
  			theta_m9[i,2,2]=-theta_m9[i,2,1];
  			
  			delta_theta9[i]=matrix_exp(delta_T9[i]*theta_m9[i,,]); //Compute the TP1 & TP2 interval probabilities
  		}	
 	
 	for(i in 1:N9)
 		for(j in 1:K)
 			for(l in 1:K)
 			delta_theta_norm9[i,j,l]=delta_theta9[i,j,l]/sum(delta_theta9[i,j,]); //normalising step so that row sum for each indiv. prob matrix is 1.
 	
 	for(i in 1:N10){
 			theta_m10[i,1,2]=exp(X10[i,1]*beta12[1]+X10[i,2]*beta12[2]+X10[i,3]*beta12[3]);
 			theta_m10[i,1,1]=-theta_m10[i,1,2];
  			theta_m10[i,2,1]=exp(X10[i,1]*beta21[1]+X10[i,2]*beta21[2]+X10[i,3]*beta21[3]);
  			theta_m10[i,2,2]=-theta_m10[i,2,1];
  			
  			delta_theta10[i]=matrix_exp(delta_T10[i]*theta_m10[i,,]); //Compute the TP1 & TP2 interval probabilities
  		}	
 	
 	for(i in 1:N10)
 		for(j in 1:K)
 			for(l in 1:K)
 			delta_theta_norm10[i,j,l]=delta_theta10[i,j,l]/sum(delta_theta10[i,j,]); //normalising step so that row sum for each indiv. prob matrix is 1.
